...
export const mutationRoutePolicies: readonly RoutePolicy[] = [
    ...
    post('/api/v1/admin/payments/:id/retry-fulfillment', { money: true }), post('/api/v1/admin/funding/reconcile-approved', { money: true }), post('/api/v1/admin/funding/:id/approve', { money: true }), post('/api/v1/admin/funding/:id/reject', { money: true }), patch('/api/v1/admin/wallets/:id/status', { money: true }), patch('/api/v1/admin/wallets/:id/limits', { money: true }),
