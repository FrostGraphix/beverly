...
export const mutationRoutePolicies: readonly RoutePolicy[] = [
    ...
    post('/api/v1/admin/auth/reset-request'), post('/api/v1/admin/auth/reset-confirm'),
    post('/api/v1/vendor/auth/email/login'), post('/api/v1/vendor/auth/reset-request'), post('/api/v1/vendor/auth/reset-confirm'),
