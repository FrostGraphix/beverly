...
export const mutationRoutePolicies: readonly RoutePolicy[] = [
    ...
    patch('/api/v1/customer/me'), post('/api/v1/customer/password-change'), post('/api/v1/customer/vend-pin'), post('/api/v1/customer/profile-picture/upload-url'), post('/api/v1/customer/profile-picture/scan'), post('/api/v1/customer/profile-picture/activate'), del('/api/v1/customer/profile-picture'), post('/api/v1/customer/logout'),
    post('/api/v1/customer/kyc/basic-info'), post('/api/v1/customer/kyc/tier1'), post('/api/v1/customer/kyc/tier1/submit'), post('/api/v1/customer/kyc/tier2/nin'), post('/api/v1/customer/kyc/tier2/submit'), post('/api/v1/customer/kyc/documents/upload-url'), post('/api/v1/customer/kyc/documents/:id/activate'), post('/api/v1/customer/meters'), del('/api/v1/customer/meters/:id'),
    ...
    post('/api/v1/admin/auth/reset-request'), post('/api/v1/admin/auth/reset-verify'), post('/api/v1/admin/auth/reset-confirm'),
    post('/api/v1/vendor/auth/email/login'), post('/api/v1/vendor/auth/reset-request'), post('/api/v1/vendor/auth/reset-verify'), post('/api/v1/vendor/auth/reset-confirm'),
    patch('/api/v1/vendor/me'), post('/api/v1/vendor/profile-picture/upload-url'), post('/api/v1/vendor/profile-picture/scan'), post('/api/v1/vendor/profile-picture/activate'), del('/api/v1/vendor/profile-picture'), post('/api/v1/vendor/kyc/documents/upload-url'), post('/api/v1/vendor/kyc/documents/:id/activate'), post('/api/v1/vendor/kyc/tier2/submit'), post('/api/v1/vendor/notifications/read-all'), patch('/api/v1/vendor/notifications/:id/read'), post('/api/v1/vendor/pwa-installed'),
    ...
    patch('/api/v1/admin/me'), post('/api/v1/admin/logout'), post('/api/v1/admin/password-change'), post('/api/v1/admin/profile-picture/upload-url'), post('/api/v1/admin/profile-picture/scan'), post('/api/v1/admin/profile-picture/activate'), del('/api/v1/admin/profile-picture'),
    ...
    del('/api/v1/admin/customers/:id'), patch('/api/v1/admin/customers/:id/status'), patch('/api/v1/admin/customers/:id/profile-picture'), post('/api/v1/admin/kyc/reviews/:id/approve'), post('/api/v1/admin/kyc/reviews/:id/reject'), post('/api/v1/admin/customer-meters/:id/approve'), post('/api/v1/admin/customer-meters/:id/reject'), post('/api/v1/admin/customer-meters/:id/unlink'), post('/api/v1/admin/purchases/:id/resend-sms'), post('/api/v1/admin/purchases/:id/resend-remote'), post('/api/v1/admin/purchases/:id/release-hold', { money: true }), post('/api/v1/admin/purchases/:id/retry-vend', { money: true }), post('/api/v1/admin/meter-orders', { money: true }), post('/api/v1/admin/meter-orders/:id/reject', { money: true }), patch('/api/v1/admin/meter-orders/:id', { money: true }), put('/api/v1/admin/meter-pricing'), patch('/api/v1/admin/fraud/:id/resolve'), patch('/api/v1/admin/disputes/:id'), post('/api/v1/admin/announcements/:id/retry-email'),
