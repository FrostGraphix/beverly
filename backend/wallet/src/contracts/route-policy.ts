...
export const mutationRoutePolicies: readonly RoutePolicy[] = [
    ...
    post('/api/v1/admin/announcements'), post('/api/v1/admin/vat-policies'), post('/api/v1/admin/vat-policies/:id/approve'), post('/api/v1/admin/refunds', { money: true }), post('/api/v1/admin/refunds/:id/approve', { money: true }), post('/api/v1/admin/refunds/:id/reject', { money: true }), post('/api/v1/admin/reconciliation/run', { money: true }), post('/api/v1/admin/feature-flags'), patch('/api/v1/admin/feature-flags/:key'), post('/api/v1/admin/consumption/refresh'), patch('/api/v1/admin/privacy/deletions/:id'),
