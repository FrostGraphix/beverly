...
function receiptHtml(model: ReceiptModel): string {
  ...
  <style>
    *{box-sizing:border-box}@page{size:A4;margin:0}html{-webkit-print-color-adjust:exact;print-color-adjust:exact;background:#fff}
    ...
    footer{text-align:center;padding-top:14px;border-top:1px solid rgba(255,214,0,.28);color:#8f98a8;font-size:10px;line-height:1.6}footer strong{display:block;color:#f8fafc;font-size:12px;margin-bottom:6px}
