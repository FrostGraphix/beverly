...
<template>
  <main class="auth-page">
    ...
    <p class="auth-cross">
      Buying electricity?
      <a :href="PORTAL_URLS.customer + 'login'" class="auth-cross-link">Open the customer portal →</a>
    </p>

    <p class="auth-legal">
      Vendor accounts are provisioned by Beverly staff.
      Contact your <a href="mailto:support@beverly.ng" class="auth-link">account manager</a> for access.
    </p>
  </main>
</template>
...
.auth-heading { margin-bottom: var(--s-5); }
