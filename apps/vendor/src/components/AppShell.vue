  ...
  <div class="bw-shell">
    ...
    <aside :class="['bw-sidebar', { open: drawerOpen }]" aria-label="Vendor primary navigation">
      ...
      <nav ref="navRef" class="bw-nav" aria-label="Vendor primary navigation">
        ...
        <RouterLink to="/kyc" :class="['bw-nav-item', { active: isItemActive('/kyc') }]" :aria-current="isItemActive('/kyc') ? 'page' : undefined" @click="closeDrawer">
          <svg class="bw-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"/><path d="m9 12 2 2 4-5"/></svg>
          KYC verification
        </RouterLink>
    ...
    <div :class="['bw-main-col', { 'bw-main-col--menu-open': userMenuOpen }]">
      <header class="bw-topbar">
        ...
        <RouterLink to="/help" class="bw-icon-btn" title="Help" aria-label="Help" style="border: none">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
