<template>
  <div class="beverly-ai-widget-wrapper">
    ...
    <button
      ...
      :class="{ active: isOpen }"
      @click="toggleWidget"
      title="Beverly AI Merchant Console Assistant"
    ...
    <div v-if="isOpen" class="beverly-ai-modal" :class="{ minimized: isMinimized }" role="dialog" aria-label="Beverly AI Merchant Assistant">
      ...
      <header class="beverly-ai-header">
        <div class="beverly-ai-brand">
          ...
          <div>
            ...
            <span class="beverly-ai-subtitle">Merchant Console</span>
          </div>
        </div>
      ...
      <template v-if="!isMinimized">
        ...
        <footer class="beverly-ai-footer">
          <div v-if="voiceStatus" id="beverly-vendor-voice-status" class="beverly-ai-voice-status" role="status" aria-live="polite">
            {{ voiceStatus }}
          </div>
