...
export interface ActionItem {
  ...
  label: string;
  action: () => void;
  icon?: 'view' | 'print' | 'copy' | 'send' | 'download' | 'dots' | 'edit' | 'delete' | 'approve' | 'reject' | 'details';
        ...
        <Transition name="bw-row-actions-pop">
          ...
          >
            ...
            >
              ...
              <!-- Edit icon -->
              <svg v-else-if="item.icon === 'edit'" class="bw-row-action-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
              <!-- Delete icon -->
              <svg v-else-if="item.icon === 'delete'" class="bw-row-action-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
              <!-- Approve icon -->
              <svg v-else-if="item.icon === 'approve'" class="bw-row-action-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
              <!-- Reject icon -->
              <svg v-else-if="item.icon === 'reject'" class="bw-row-action-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
              <!-- Details icon -->
              <svg v-else-if="item.icon === 'details'" class="bw-row-action-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
