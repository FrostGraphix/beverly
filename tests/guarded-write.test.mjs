...
assert.equal(guardedWriteMessage("Remote task"), "Remote task queued locally. Live writes are off.");
assert.equal(userFacingError({ response: { status: 403 } }), "Action queued locally. Live writes are off.");
