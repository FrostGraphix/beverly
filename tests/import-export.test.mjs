...
assert.deepStrictEqual(customerTemplateValidated.rows, [{
  id: "47005349023",
  name: "VICTORIA ODEGBILE",
  phone: "",
  address: "BONDU",
...
assert.deepStrictEqual(duplicateCustomerValidated.errors, [{
  row: 3,
  field: "id",
  message: "Duplicate Customer IDs: 47005356697 (first: row 2)",
  kind: "duplicate",
  item: "47005356697",
  summary: "Duplicate Customer IDs"
}]);
...
const accountTemplateValidated = validateImportRows(accountImportRoute, [{
  "Customer Id": "CUS-001",
  "Meter Id": "MTR-1001",
  "Tariff Id": "TAR-01",
  "CT Ratio": "1",
...
const invalidAccountRatio = validateImportRows(accountImportRoute, [{
  "Customer Id": "CUS-001",
  "Meter Id": "MTR-1001",
  "Tariff Id": "TAR-01",
  "CT Ratio": ""
}], columnKey);
assert.deepStrictEqual(invalidAccountRatio.errors, [{
  row: 2,
  field: "CT Ratio",
  message: "CT Ratio is required"
}]);
