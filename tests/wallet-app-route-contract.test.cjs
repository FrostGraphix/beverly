...
function main() {
  ...
  assert.match(vendorFundingHistory, /WalletExportWizard/);
  assert.match(vendorFundingHistory, /:formats="\['pdf'\]"/);
  assert.match(vendorFundingHistory, /filename="beverly-vendor-funding-history"/);
  ...
  assert.match(vendorStatement, /WalletExportWizard/);
  assert.match(vendorStatement, /:formats="\['pdf'\]"/);
  assert.match(vendorTransactions, /WalletExportWizard/);
  assert.match(vendorTransactions, /:formats="\['pdf'\]"/);
  assert.match(vendorTransactions, /has_more/);
  assert.match(vendorTransactions, /resolveTransactionExport/);
