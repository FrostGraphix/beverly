...
assert(html.includes(".detail-item.wide"));
assert(html.includes(".detail-section { grid-template-columns: repeat(2, minmax(0, 1fr)); }"));
assert(html.includes('class="detail-item wide"'));
