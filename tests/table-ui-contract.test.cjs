...
const tableService = readProjectFile("src/services/table-service.js");
...
assertIncludes(tablePage, "fetchTableData(meterRoute, { pageNumber: 1, pageSize: 50, bulkRead: true, siteId: this.selectedSite })");
assertIncludes(tableService, "hash.includes(\"admin/station\")");
