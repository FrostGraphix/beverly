...
assert.match(route, /reportTransactionStatusSchema/);
assert.match(route, /transaction_status/);
assert.match(route, /entity_id/);
...
assert.match(page, /wizardStep/);
assert.match(page, /Successful only/);
assert.match(page, /Failed only/);
assert.match(page, /All stations/);
