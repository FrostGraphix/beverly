...
## 5. Lead Software Architect

### Goal

Make Claude act as a production-grade lead architect and full-stack engineer. Strict architecture compliance. Deep context awareness. No shortcuts.

### When To Use

- starting a new feature or module
- adding files to a layered architecture
- enforcing separation of concerns
- reviewing structure before implementation
- cross-layer work (frontend + backend + shared)
...
1. reads architecture first
2. states filepath and reasoning
3. checks for existing patterns
4. writes fully typed code
5. flags conflicts before building
6. suggests tests after

### Best Use Notes

- best for layered production apps
- best for enforcing architecture parity
- best for onboarding new modules cleanly
