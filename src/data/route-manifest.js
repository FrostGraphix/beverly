export const routeManifest = [
  ...
  { group: "Data Report", title: "Archive Reports", hash: "#/prepay-report/archive-reports", apis: ["/api/local/archive/reports/summary", "/api/local/archive/reports/list", "/api/local/archive/reports/download"], columns: ["oemSlug", "stationId", "status", "reportTypes", "coversFrom", "coversTo", "reportCount", "rowCount", "byteSize", "refreshedAt", "Actions"], actions: ["Export archives", "Refresh"], isCustomPage: true, customComponent: "ArchiveReportsPage", note: "Site-first archive inventory with browser-built multi-report bundles", roles: ["super-admin", "operations-manager", "account"] },
  ...
  { group: "Administration", title: "Meter", hash: "#/admin/meter", apis: ["/api/meter/read"], columns: ["meterId", "meterType", "communicationWay", "protocolVersion", "status", "stationId", "remark", "Actions"], actions: ["Sort", "Search", "Reset", "Add", "Import", "Export", "Move Station", "Delete", "Edit", "Cancel", "Confirm"], roles: ["super-admin"] },
